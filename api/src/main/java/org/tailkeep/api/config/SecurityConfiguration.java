        ...
        http
                ...
                .authorizeHttpRequests(req ->
                        req.requestMatchers(WHITE_LIST_URL)
                                .permitAll()
                                .requestMatchers(POST, "/api/v1/downloads/**").hasAnyAuthority(ADMIN_CREATE.getPermission())
                                .requestMatchers(PUT, "/api/v1/downloads/**").hasAnyAuthority(ADMIN_UPDATE.getPermission())
                                .requestMatchers(DELETE, "/api/v1/downloads/**").hasAnyAuthority(ADMIN_DELETE.getPermission())
